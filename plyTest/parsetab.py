...
_lr_productions = [
  ...
  ('expression -> expression PLUS term','expression',3,'p_add','calc.py',10),
  ('expression -> expression MINUS term','expression',3,'p_sub','calc.py',15),
  ('expression -> term','expression',1,'p_term','calc.py',20),
  ('term -> term TIMES factor','term',3,'p_term_factor','calc.py',25),
  ('term -> term DIVIDE factor','term',3,'p_term_divide','calc.py',30),
  ('term -> factor','term',1,'p_factor','calc.py',35),
  ('factor -> NUMBER','factor',1,'p_factor_num','calc.py',40),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_fact_param','calc.py',45),
]
